...
const UNITS = [
  ...
  { id: 'line',   name: 'LINE SUITS',   role: 'line', era: 1, slots: 1,  cost: 245, n: 6, hp: 105, dmg: 10, minR: 1, maxR: 5, br: [2,4,5],
    speed: 0.79, ap: 1, save: 6, splash: 0, acc: 0,
    note: 'The mass-produced answer to everything and the best answer to nothing.' },
  { id: 'heavy',  name: 'HEAVY SUITS',  role: 'line', era: 2, slots: 2,  cost: 420, n: 4, hp: 273, dmg: 24, minR: 1, maxR: 5, br: [2,3,5],
    speed: 0.57, ap: 2, save: 5, splash: 0, acc: 0,
    note: 'Slower, thicker, and it takes real armour-piercing to move them.' },
  { id: 'lancers',name: 'LANCERS',      role: 'fast', era: 1, slots: 2,  cost: 520, n: 3, hp: 222, dmg: 58, minR: 1, maxR: 1, br: [1,1,1],
    speed: 2.04, ap: 3, save: 6, splash: 0, acc: -1,
    note: 'Closes fast and ignores armour. Cannot shoot anything it has not reached.' },
  { id: 'skirm',  name: 'SKIRMISHERS',  role: 'fast', era: 2, slots: 2,  cost: 400, n: 3, hp: 199, dmg: 44, minR: 1, maxR: 4, br: [2,3,4],
    speed: 1.39, ap: 1, save: 6, splash: 0, acc: 0,
    note: 'Fast enough to choose its range. Hits hardest where nobody is looking.' },
  { id: 'siege',  name: 'SIEGE WALKERS',role: 'siege', era: 2, slots: 3, cost: 670, n: 2, hp: 295, dmg: 71, minR: 3, maxR: 9, br: [5,7,9],
  ...
  { id: 'missile',name: 'MISSILE TRACK',role: 'siege', era: 3, slots: 2, cost: 590, n: 3, hp: 144, dmg: 40, minR: 2, maxR: 7, br: [4,6,7],
  ...
  { id: 'colossus',name:'COLOSSUS',     role: 'heavy', era: 3, slots: 3, cost: 570, n: 1, hp: 1750,dmg: 93, minR: 1, maxR: 6, br: [2,4,6],
  ...
  { id: 'ace',    name: 'ACE FRAME',    role: 'ace', era: 3, slots: 3,   cost: 810, n: 1, hp: 905, dmg: 156,minR: 1, maxR: 6, br: [3,5,6],
